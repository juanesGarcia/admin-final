...
class DataSource {
    ...
    public function __construct(){
        ...
        try{
            ...
            $this->cadenaConexion="mysql:host=localhost;dbname=datospg1;charset=utf8";
    ...
    public function ejecutarConsulta($sql="", $values=array()){
        ...
        if($sql != ""){
            ...
            $consulta=$this->conexion-> prepare("SELECT * FROM usuario WHERE email = :email AND contraseña = :pswd");
    ...
    public function ejecutarActualizacion1($sql="", $values=array()){
