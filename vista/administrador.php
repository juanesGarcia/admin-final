...
<body onload="__construct()">
  ...
  <form action="../modelo/dao/DataSource.php" id="form" method="POST" enctype="multipart/form-data">
    <div class="container__tabla container__tabla__editar">
      ...
      <?php while ($row = mysqli_fetch_assoc($resultado)) { ?>
        ...
        <div class="tabla__item">
          ...
          <a href="adminmodificar.php?id=<?php echo $row["idusuario"]; ?>" class="tabla__item__link">Modificar</a> |

          <a href="eliminar.php?id=<?php echo $row["idusuario"]; ?>" class="tabla__item__link">Eliminar</a>

          </a><a href="" class="tabla__item__link"></a>
        </div>
    ...
    <a class="btn btn-dark" href="../mostrarpdf//imprimirpdf.php" id="btnim">Imprimir</a>
